...
def connect_square_to_detection(detections, square):
	...
	for box in detections:
		...
		#cut high pieces        
		if box_y4 - box_y1 > 45:
			box_complete = np.array([[box_x1,box_y1+25], [box_x2-5, box_y2+25], [box_x3-5, box_y3], [box_x4, box_y4]])
		else:
...
def main():
	...
	chessboard_image = cv2.imread('D:/ComputerVision-Final-Project/corner-detection-dataset/my-test/1a8a4abcba7c4ead35c01f05b9fae8e5_jpg.rf.442f136a399a1f9fe7ebdbfb4ba111a1.jpg')
	...
	print (t_detections)    
	print (suppedB)
	# tp = cv2.perspectiveTransform(333, perspective_matrix)
	# print (tp)
	...
	print (transformed_bounding_boxes[0][0][0][0])
